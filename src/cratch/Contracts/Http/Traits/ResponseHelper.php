...
trait ResponseHelper
{
     ...
     * @return string
     */
    public function returnJson($data, $code): string
    {
     ...
     * @return Response
     */
    public function setContent($key): Response
    {
        if (is_array($key)) {
     ...
     * @return Response
     */
    public function setHeader($key): Response
    {
        if (is_array($key)) {
            $this->setHeaders($key);
        } else {
     ...
     * @param array $keys
     */
    private function setContents(array $keys): void
    {
        foreach ($keys as $k) {
     ...
     * @param array $keys
     */
    private function setHeaders(array $keys): void
    {
        foreach ($keys as $k => $v) {
            header($k.$v);
        }
